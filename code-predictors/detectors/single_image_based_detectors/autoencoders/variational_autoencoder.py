...
class VariationalAutoencoder(AbstractSingleImageAD, AnomalyDetector):

    def __init__(self, name, args, intermediate_dim=512, latent_dim=2):
        self.intermediate_dim = intermediate_dim
        self.latent_dim = latent_dim
        super(VariationalAutoencoder, self).__init__(name=name, is_keras_model=True, args=args)
